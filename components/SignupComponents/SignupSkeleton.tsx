      ...
      >
        ...
        <div className="mb-8">
          <motion.div
            ...
            className="h-8 bg-gradient-to-r from-zinc-900 via-zinc-800 to-zinc-900 rounded-lg mb-3 w-48"
            style={{ backgroundSize: '200% 100%' }}
          />
          <motion.div
            animate={{ backgroundPosition: ['0% 0%', '100% 0%', '0% 0%'] }}
            transition={{ duration: 2, repeat: Infinity, delay: 0.1 }}
            className="h-4 bg-gradient-to-r from-zinc-900 via-zinc-800 to-zinc-900 rounded-lg w-56"
            style={{ backgroundSize: '200% 100%' }}
          />
        </div>
